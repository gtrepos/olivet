...
<form name="form_produit" action='index.php?page=produits&action=enregistrer&mode=creation' method="post"
	  onsubmit="return false;">
		<table>
			...
			<tr><td colspan="2">&nbsp;</tr>
			<tr><td>Catégorie : </td><td><?php liste_categories('-1', null);?></td></tr>
			<tr><td>Producteur : </td><td><?php liste_producteurs('-1');?></td></tr>
			...
			<tr>
				<td>Jours dispos : </td><td>
					<input type='checkbox' name='jourDispo' value='2'>Mardi</input>
					<input type='checkbox' name='jourDispo' value='3'>Mercredi</input> 
					<input type='checkbox' name='jourDispo' value='4'>Jeudi</input> 
					<input type='checkbox' name='jourDispo' checked value='5'>Vendredi</input>
					<input type='checkbox' name='jourDispo' checked value='6'>Samedi</input>
